...
3. Build the project ("WpfCameraBarcodeReaderDemo.Net10.csproj" file) in Visual Studio or using .NET CLI:
   ```
   dotnet build WpfCameraBarcodeReaderDemo.Net10.csproj
   ```
